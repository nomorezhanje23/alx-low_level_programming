 ...
 * @e_ident: pointer to array with ELF magic num
...
/**
 * print_magic -this prints the magic numbz of an ELF header
 * @e_ident: pointer to an array with the ELF magic numbz
 * Description: the magic numbz are separated by spaces
 */
void print_magic(unsigned char *e_ident)
{
	int index;
 ...
 * @e_entry: this address of the ELF entry point
...
/**
 * main - this displays the information with ELF header
